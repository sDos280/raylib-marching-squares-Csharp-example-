...
namespace engine
{
    public class Perlin
    {
        ...
        public static double OctavePerlin(double x, double y, double z, int octaves, double persistence, int repeat)
        {
            double total = 0;
            double frequency = 1;
            double amplitude = 1;
        ...
        public static double perlin(double x, double y, double z, int repeat)
        {
            if (repeat > 0)
